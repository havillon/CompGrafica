...
Malha Cubo::criarCubo(Vetor centroBase, double comprimentoAresta, Vetor Ka, Vetor Kd, Vetor Ke, double shininess){
    ...
    malha->adicionarVertice(
        new Vertice(
            Vetor(0, 0, 0, 1), Vetor(0,0,0,0)
        )
    );
    malha->adicionarVertice(
        new Vertice(
            Vetor(0, 0, 1, 1), Vetor(0,0,0,0)
        )
    );
    malha->adicionarVertice(
        new Vertice(
            Vetor(1, 0, 1, 1), Vetor(0,0,0,0)
        )
    );
    malha->adicionarVertice(
        new Vertice(
            Vetor(1, 0, 0, 1), Vetor(0,0,0,0)
        )
    );
    malha->adicionarVertice(
        new Vertice(
            Vetor(0, 1, 0, 1), Vetor(0,0,0,0)
        )
    );
    malha->adicionarVertice(
        new Vertice(
            Vetor(0, 1, 1, 1), Vetor(0,0,0,0)
        )
    );
    malha->adicionarVertice(
        new Vertice(
            Vetor(1, 1, 1, 1), Vetor(0,0,0,0)
        )
    );
    malha->adicionarVertice(
        new Vertice(
            Vetor(1, 1, 0, 1), Vetor(0,0,0,0)
        )
    );

    malha->adicionarAresta(
        Aresta(0, 1)
    );
    malha->adicionarAresta(
        Aresta(1, 2)
